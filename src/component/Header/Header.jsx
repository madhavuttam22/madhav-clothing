  ...
  return (
    <header className="bg-light border-bottom py-2">
      <div className="container d-flex justify-content-between align-items-center">
        {/* Logo */}
        <Link to="/" className="text-dark text-decoration-none fs-4 fw-bold">
          LOGO
        </Link>
        ...
        <nav className="d-flex gap-3">
          ...
          <Link to="/allproducts" className="text-dark text-decoration-none">All Products</Link>
          <Link to="/bestseller" className="text-dark text-decoration-none">Best Sellers</Link>
          <Link to="/brand" className="text-dark text-decoration-none">Brand</Link>
        ...
        <div className="d-flex align-items-center gap-3">
          ...
          {/* Profile */}
          <button onClick={handleProfileClick} className="btn btn-outline-secondary">
            <BiUser />
          </button>
