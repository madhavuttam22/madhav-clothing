...
const BrandPage = () => {
  useEffect(() => {
    document.title = "BrandPage | Madhav Clothing";
  }, []);
  return (
    <>
        ...
        <section className="features-section">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card color-card">
              ...
              <h3>Unique Colors</h3>
              <p>
                India has always been an epitome of rich culture and vibrant
                colors. Taking this inspiration forward we make sure to provide
                our consumers with a diverse mix of fabric colors to suit the
                fashion sense of every individual. With over 50 new colors
                introduced every season we ensure a Fashion First approach.
              </p>
            ...
            <div className="feature-card factory-card">
              ...
              <p>
                We're vertically integrated to deliver perfect quality at the
                right price by eliminating middlemen. With 25+ years in garment
                design, manufacturing and distribution, we offer the ideal mix
                of quality and price with nominal margins.
              </p>
              {/* Stats visualization */}
              <div className="stats">
                <div className="stat">
